...
type Props = {
  onSelectUser: Parameters<typeof FollowingList>[0]["onSelectUser"];
};

export default function FollowingPanel({ onSelectUser }: Props) {
  return (
    <QueryBoundary
      fallback={
        <FollowListState>
    ...
    >
      <FollowingList onSelectUser={onSelectUser} />
    </QueryBoundary>
  );
}
