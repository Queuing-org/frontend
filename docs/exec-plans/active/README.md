...
- [2026-09-01-automatic-replay-state](./2026-09-01-automatic-replay-state/plan.md): ci-pending — 자동 순환 상태를 59px 아이콘과 parent flex 기반 list area 중앙으로 교정하고 로컬 QA·fresh review 통과
