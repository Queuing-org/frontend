...
- local_qa: pass (scroll follow-up targeted 2 files/20 tests, `npm run lint`, `npm run build`, `git diff --check`, fresh read-only QA fix→pass; preceding full 108 files/346 tests pass)
